...
from dagerputy.dagerputyapp.views import (
...
from dagerputy.dagerputyapp.views import (InstanceListView, InstanceDetailView,
...
from dagerputy import rest_urls
...
urlpatterns = [
     ...
     url(r'^docs/', include_docs_urls(title="Dagerputy API", description="An API to create and view Dagerputy checks and services."))
]
...
def append_plugin_urls():
    ...
    """
    global urlpatterns
    for plugin in settings.DAGERPUTY_PLUGINS_ENABLED_PARSED:
        try:
