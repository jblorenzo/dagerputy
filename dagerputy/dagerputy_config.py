...
# So that links back to the Dagerputy instance display correctly
WWW_HTTP_HOST = os.environ.get('WWW_HTTP_HOST')
WWW_SCHEME = os.environ.get('WWW_SCHEME', "https")

HTTP_USER_AGENT = os.environ.get('HTTP_USER_AGENT', 'Dagerputy')
...
DAGERPUTY_PLUGINS_ENABLED = os.environ.get('DAGERPUTY_PLUGINS_ENABLED', 'dagerputy_alert_hipchat,dagerputy_alert_twilio,dagerputy_alert_email')
