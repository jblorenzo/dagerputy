...
def move_old_jenkins_checks(apps, schema_editor):
    ...
    JenkinsStatusCheck = apps.get_model("dagerputyapp", "JenkinsStatusCheck")
    JenkinsCheck = apps.get_model("dagerputyapp", "JenkinsCheck")
    JenkinsConfig = apps.get_model("dagerputyapp", "JenkinsConfig")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dagerputyapp', '0004_auto_20170802_1327'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='JenkinsCheck',
            fields=[
                ('statuscheck_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='dagerputyapp.StatusCheck')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='jenkins_config',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dagerputyapp.JenkinsConfig'),
        ),
