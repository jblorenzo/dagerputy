    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(related_name='polymorphic_dagerputyapp.alertplugin_set', editable=False, to='contenttypes.ContentType', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(related_name='polymorphic_dagerputyapp.alertpluginuserdata_set', editable=False, to='contenttypes.ContentType', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alerts', models.ManyToManyField(help_text=b'Alerts channels through which you wish to be notified', to='dagerputyapp.AlertPlugin', blank=True)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance', models.ForeignKey(related_name='snapshots', to='dagerputyapp.Instance')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alerts', models.ManyToManyField(help_text=b'Alerts channels through which you wish to be notified', to='dagerputyapp.AlertPlugin', blank=True)),
                ('instances', models.ManyToManyField(help_text=b'Instances this service is running on.', to='dagerputyapp.Instance', blank=True)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overall_status', models.TextField(default=b'PASSING')),
                ('did_send_alert', models.IntegerField(default=False)),
                ('service', models.ForeignKey(related_name='snapshots', to='dagerputyapp.Service')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(related_name='polymorphic_dagerputyapp.statuscheck_set', editable=False, to='contenttypes.ContentType', null=True)),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check', models.ForeignKey(to='dagerputyapp.StatusCheck')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='service',
            name='status_checks',
            field=models.ManyToManyField(help_text=b'Checks used to calculate service status.', to='dagerputyapp.StatusCheck', blank=True),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(editable=False, to='dagerputyapp.UserProfile'),
            preserve_default=True,
        ),
        ...
        migrations.AddField(
            ...
            name='service',
            field=models.ForeignKey(to='dagerputyapp.Service'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='alertacknowledgement',
        ...
        migrations.CreateModel(
            ...
            bases=('dagerputyapp.statuscheck',),
        ),
        migrations.CreateModel(
